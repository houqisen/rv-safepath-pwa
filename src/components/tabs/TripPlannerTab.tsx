                                        ...
                                        <div>
                                          <div className="flex items-center justify-between gap-1 mb-1">
                                            ...
                                            {sIdx > 0 && formattedPrevArrTime && (
                                              prevStopArrTotalMins !== undefined && currentDepTotalMins < prevStopArrTotalMins ? (
                                                <span className="text-[9px] text-amber-400 font-semibold" title={`Departure is earlier than Stop ${sIdx} arrival (${formattedPrevArrTime})`}>
                                                  ⚠️ Earlier than Arr ({formattedPrevArrTime})
                                                </span>
                                              ) : (
                                                <span className="text-[9px] text-emerald-400 font-medium" title={`Stop ${sIdx} arrival time`}>
                                                  (Prev Arr: {formattedPrevArrTime})
                                                </span>
                                              )
                                            )}
                                          </div>
